    ...
    <section id="contact" className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto mb-16 text-lg">
            ...
            return (
              ...
              >
                <Tag
                  ...
                  className="flex items-center gap-4 bg-card border border-border rounded-2xl p-5 group hover:border-primary/30 transition-all duration-300 cursor-pointer"
                >
        ...
        >
          {[
            ...
            <MagneticButton key={social.label} href={social.href} className="w-14 h-14 rounded-2xl border border-border flex items-center justify-center hover:border-primary hover:text-primary transition-all duration-300 bg-card/50 backdrop-blur-sm inline-flex">
              {social.icon}
            </MagneticButton>
          ))}
        </motion.div>
